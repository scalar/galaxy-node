...
| `oAuth2` | `string \| AuthTokenProvider` | `process.env["SCALAR_O_AUTH2"]` | OAuth 2.0 authentication |
| `openIDConnect` | `string \| AuthTokenProvider` | `process.env["SCALAR_OPEN_ID_CONNECT"]` | OpenID Connect Authentication |
